...
exports.sortByKeysFn = exports.encodeDoc = exports.decodeDoc = exports.isDocumentPath = exports.isCollectionPath = exports.cleanCollectionPath = void 0;
...
var cleanCollectionPath = function (path) {
    if (typeof path === 'string') {
        var p = ('/' + path + '/').replace(/\/{2,}/, '/').split('/').filter(function (v) { return !!v; }).join('/');
        return p || '/';
    }
    else {
        return (0, exports.cleanCollectionPath)(path.join('/'));
    }
};
exports.cleanCollectionPath = cleanCollectionPath;
var isCollectionPath = function (path) {
    var sections = (0, exports.cleanCollectionPath)(path).split('/').length;
    return sections % 2 === 1;
};
exports.isCollectionPath = isCollectionPath;
var isDocumentPath = function (path) {
    var sections = (0, exports.cleanCollectionPath)(path).split('/').length;
    return sections % 2 === 0;
};
    ...
    function FieldHandler(prefix) {
        ...
        this.isEncodeType = function (key, val, doc) {
            if (typeof val !== 'string')
                return false;
            return val.startsWith("{\"type\":\"".concat(_this.prefix, "\""));
        };
...
var ReferenceFH = /** @class */ (function (_super) {
    ...
    function ReferenceFH() {
        ...
        _this.encodeFn = function (key, val, doc) {
            var data = val.data;
            return admin.firestore().doc(data);
        };
        return _this;
    }
    return ReferenceFH;
...
var TestFH = /** @class */ (function (_super) {
    ...
    function TestFH() {
        ...
        _this.isDecodeType = function (key, val, doc) {
            if (['_a'].includes(key)) {
                // if (1) {
                console.log("Test isDecode on ".concat(key, " = ").concat(toType(val)));
                console.log('typeof', typeof val);
                console.log('instanceof', val instanceof Object);
                console.log('isNull', (0, util_1.isNull)(val));
                console.log('val', val);
            }
            return false;
        };
        _this.isEncodeType = function (key, val, doc) {
            if (key === 'o') {
                console.log("Test isEncode on ".concat(key, " = ").concat(toType(val)));
                console.log('typeof', typeof val);
                console.log('instanceof', val instanceof Object);
                console.log('val', val);
            }
...
function decodeDoc(doc) {
    lodash.forEach(doc, function (fieldValue, fieldName) {
