...
import { decodeDoc, sortByKeysFn } from './shared';

let db: admin.firestore.Firestore;
let args;

export const execute = async (app: admin.app.App, file: string, collectionPaths: string[], options) => {
	db = app.firestore();
	args = options;
